...
graphs_data = {
    ...
    "Mag_Y": (x_values, [random.uniform(-100, 100) for _ in range(8)]),  # Added Mag_Y
    "Auto_Gyro_Rotation_Rate": (x_values, [random.uniform(-360, 360) for _ in range(8)])  # Added Auto_Gyro_Rotation_Rate
}
